...
import (
	...
	"github.com/ZachAndrews98/pulumi-konnect/internal/provider/pkg/version"
...
func convertName(tfname string) (module string, name string) {
	...
	contract.Assertf(tfNameItems[0] == "konnect", "Invalid snake case name %s. Does not start with konnect", tfname)
...
func makeDataSource(ds string) tokens.ModuleMember {
	...
	return tfbridge.MakeDataSource("konnect", mod, "get"+name)
}

func makeResource(res string) tokens.Type {
	mod, name := convertName(res)
	return tfbridge.MakeResource("konnect", mod, name)
}
...
func Provider() tfbridge.ProviderInfo {
	...
	p := pf.ShimProvider(provider.NewProvider())
	...
	prov := tfbridge.ProviderInfo{
		...
		// there.
		Publisher: "ZachAndrews98",
		// LogoURL is optional but useful to help identify your package in the Pulumi Registry
		// if this package is published there.
		//
		// You may host a logo on a domain you control or add an SVG logo for your package
		// in your repository and use the raw content URL for that file as your logo URL.
		LogoURL: "https://raw.githubusercontent.com/ZachAndrews98/pulumi-konnect/main/docs/konnect.png",
		// PluginDownloadURL is an optional URL used to download the Provider
		// for use in Pulumi programs
		// e.g https://github.com/org/pulumi-provider-name/releases/
		PluginDownloadURL: "github://api.github.com/ZachAndrews98/pulumi-konnect",
		...
		License:    "Apache-2.0",
		Homepage:   "https://github.com/ZachAndrews98/pulumi-konnect",
		Repository: "https://github.com/ZachAndrews98/pulumi-konnect",
		// The GitHub Org for the provider - defaults to `terraform-providers`. Note that this
		// should match the TF provider module's require directive, not any replace directives.
		Version:           version.Version,
		GitHubOrg:         "kong",
		MetadataInfo:      tfbridge.NewProviderMetadata(bridgeMetadata),
		TFProviderVersion: "0.6.2",
		...
		JavaScript: &tfbridge.JavaScriptInfo{
			PackageName: "@pulumiverse/konnect",
		...
		Python: &tfbridge.PythonInfo{
			PackageName: "pulumiverse_konnect",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: filepath.Join(
				fmt.Sprintf("github.com/ZachAndrews98/pulumi-%[1]s/sdk/", "konnect"),
